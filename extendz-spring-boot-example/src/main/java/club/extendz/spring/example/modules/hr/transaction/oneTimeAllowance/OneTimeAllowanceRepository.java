...
public interface OneTimeAllowanceRepository extends PagingAndSortingRepository<OneTimeAllowance, Long>,
		QueryDslPredicateExecutor<OneTimeAllowance>, QuerydslBinderCustomizer<QOneTimeAllowance> {
	@Override
	default void customize(QuerydslBindings bindings, QOneTimeAllowance oneTimeAllowance) {
